...
/**
 * BinaryTreePreOrderIterator class.
 *
 * @author Jessica Li
 * @version 12/18/15
 */
public class BinaryTreePreOrderIterator<E> implements Iterator<E>
{
	 ...
	 * Checks in case of nulls and calls root, left, right.  
	 *
	 * @param t 	the BinaryTree to be iterated through
	 */ 
